  ...
  return {
    visitor: {
      CallExpression: function CallExpression(path) {
        ...
        if (['Identifier', 'MemberExpression', 'ObjectExpression', 'CallExpression'].indexOf(path.node.callee.object.type) === -1) {
          return;
        }
...
var METHODS = ['keys', 'values', 'contains', 'count', 'has', 'get', 'set', 'sum', 'avg', 'each', 'slice', 'reduce', 'toArray', 'chunk', 'except', 'filter', 'isEmpty', 'isNotEmpty', 'first', 'last', 'map', 'mapWithKeys', 'flatten', 'min', 'max', 'only', 'pipe', 'pluck', 'reject', 'swap', 'take', 'unique', 'diff', 'diffKeys', 'intersect', 'intersectByKeys', 'merge', 'keyBy', 'groupBy', 'sort', 'sortDesc', 'sortBy', 'sortByDesc', 'append', 'prepend', 'index', 'insert', 'join', 'partition', 'flip', 'fill', 'freeze', 'isFrozen', 'flatMap', 'reverse'];